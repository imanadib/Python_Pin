...
void INS_IPOINT_BEFORE(SPPY::PyObject* callback, INS ins_object, UINT32 num_operands, unsigned int rax, unsigned int rbx, unsigned int rcx, unsigned int rdx, unsigned int rdi, unsigned int rsi, unsigned int rbp, unsigned int rsp, UINT64 memop0, unsigned int memop1, unsigned int memop2) {
    SPPY::PyObject* dict = Dyno::PyDict_New();
    SPPY::PyObject* arguments = Dyno::PyTuple_New(1);

    #ifdef __i386__
    Dyno::PyDict_SetItemString(dict, "REG_EAX", Dyno::PyInt_FromLong(rax));
    Dyno::PyDict_SetItemString(dict, "REG_EBX", Dyno::PyInt_FromLong(rbx));
    Dyno::PyDict_SetItemString(dict, "REG_ECX", Dyno::PyInt_FromLong(rcx));
    Dyno::PyDict_SetItemString(dict, "REG_EDX", Dyno::PyInt_FromLong(rdx));
    Dyno::PyDict_SetItemString(dict, "REG_EDI", Dyno::PyInt_FromLong(rdi));
    Dyno::PyDict_SetItemString(dict, "REG_ESI", Dyno::PyInt_FromLong(rsi));
    Dyno::PyDict_SetItemString(dict, "REG_EBP", Dyno::PyInt_FromLong(rbp));
    Dyno::PyDict_SetItemString(dict, "REG_ESP", Dyno::PyInt_FromLong(rsp));
    switch (num_operands) {
        case 0:
        break;
        case 1:
        Dyno::PyDict_SetItemString(dict, "MEM_OP0", Dyno::PyInt_FromLong(memop0));
        case 2:
        Dyno::PyDict_SetItemString(dict, "MEM_OP1", Dyno::PyInt_FromLong(memop1));
        case 3:
        Dyno::PyDict_SetItemString(dict, "MEM_OP2", Dyno::PyInt_FromLong(memop2));
        break;
    }
    ...
    Dyno::PyDict_SetItemString(dict, "VAL", Dyno::PyInt_FromLong(k));
    Dyno::PyDict_SetItemString(dict, "REG_RAX", Dyno::PyInt_FromLong(rax));
    Dyno::PyDict_SetItemString(dict, "REG_RBX", Dyno::PyInt_FromLong(rbx));
    Dyno::PyDict_SetItemString(dict, "REG_RCX", Dyno::PyInt_FromLong(rcx));
    Dyno::PyDict_SetItemString(dict, "REG_RDX", Dyno::PyInt_FromLong(rdx));
    Dyno::PyDict_SetItemString(dict, "REG_RDI", Dyno::PyInt_FromLong(rdi));
    Dyno::PyDict_SetItemString(dict, "REG_RSI", Dyno::PyInt_FromLong(rsi));
    Dyno::PyDict_SetItemString(dict, "REG_RBP", Dyno::PyInt_FromLong(rbp));
    Dyno::PyDict_SetItemString(dict, "REG_RSP", Dyno::PyInt_FromLong(rsp));
    Dyno::PyDict_SetItemString(dict, "IP", Dyno::PyInt_FromLong(INS_Address(ins_object)));
   // Dyno::PyDict_SetItemString(dict, "EA", Dyno::PyInt_FromLong(ea));
    Dyno::PyDict_SetItemString(dict, "mnemonic", Dyno::PyString_FromString(INS_Disassemble(ins_object).c_str()));
    switch (num_operands) {
        case 0:
        break;
        case 1:
    ...
    #endif
    Dyno::PyTuple_SetItem(arguments, 0, dict);
...
SPPY::PyObject* Python_INS_InsertCall(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k|k|O", &ipoint, &ins, &callable);
    if (!Dyno::PyCallable_Check(callable)) {
...
SPPY::PyObject* Python_INS_Category(SPPY::PyObject* self, SPPY::PyObject* args) {
    SPPY::PyObject* ins;
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_Category(ins_object));
}
...
SPPY::PyObject* Python_INS_Extension(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_Extension(ins_object));
}

SPPY::PyObject* Python_INS_MemoryOperandSize(SPPY::PyObject* self, SPPY::PyObject* args) {
    SPPY::PyObject* ins;
    SPPY::PyObject* memoryop;
    Dyno::PyArg_ParseTuple(args, "k|O", &ins, &memoryop);
    INS ins_object = *(INS*) ins;
    UINT32 memoryop_object = (UINT32) Dyno::PyInt_AsLong(memoryop);
    return Dyno::Py_BuildValue("k", INS_MemoryOperandSize(ins_object, memoryop_object));
}
...
SPPY::PyObject* Python_INS_MemoryWriteSize(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_MemoryWriteSize(ins_object));
}
...
SPPY::PyObject* Python_INS_GetPredicate(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_GetPredicate(ins_object));
}
...
SPPY::PyObject* Python_INS_MemoryReadSize(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_MemoryReadSize(ins_object));
}
...
SPPY::PyObject* Python_OPCODE_StringShort(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "O", &opcode);
    UINT32 opcode_object = (UINT32) Dyno::PyInt_AsLong(opcode);
    return Dyno::Py_BuildValue("s", OPCODE_StringShort(opcode_object).c_str());
}
...
SPPY::PyObject* Python_INS_Mnemonic(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("s", INS_Mnemonic(ins_object).c_str());
}
...
SPPY::PyObject* Python_INS_RegR(SPPY::PyObject* self, SPPY::PyObject* args) {
    SPPY::PyObject* x;
    SPPY::PyObject* k;
    Dyno::PyArg_ParseTuple(args, "k|O", &x, &k);
    INS x_object = *(INS*) x;
    UINT32 k_object = (UINT32) Dyno::PyInt_AsLong(k);
...
SPPY::PyObject* Python_INS_Opcode(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    *opcode_return = INS_Opcode(ins_object);
    return Dyno::Py_BuildValue("k", opcode_return);
}

SPPY::PyObject* Python_CATEGORY_StringShort(SPPY::PyObject* self, SPPY::PyObject* args) {
    SPPY::PyObject* num;
    Dyno::PyArg_ParseTuple(args, "O", &num);
    UINT32 num_object = (UINT32) Dyno::PyInt_AsLong(num);
    return Dyno::Py_BuildValue("s", CATEGORY_StringShort(num_object).c_str());
}
...
SPPY::PyObject* Python_EXTENSION_StringShort(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "O", &num);
    UINT32 num_object = (UINT32) Dyno::PyInt_AsLong(num);
    return Dyno::Py_BuildValue("s", EXTENSION_StringShort(num_object).c_str());
}
...
SPPY::PyObject* Python_INS_MaxNumRRegs(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS x_object = *(INS*) x;
    return Dyno::Py_BuildValue("k", INS_MaxNumRRegs(x_object));
}
...
SPPY::PyObject* Python_INS_MaxNumWRegs(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &x);
    INS x_object = *(INS*) x;
    return Dyno::Py_BuildValue("k", INS_MaxNumWRegs(x_object));
}

SPPY::PyObject* Python_INS_RegRContain(SPPY::PyObject* self, SPPY::PyObject* args) {
    SPPY::PyObject* ins;
    SPPY::PyObject* reg;
    Dyno::PyArg_ParseTuple(args, "k|k", &ins, &reg);
    INS ins_object = *(INS*) ins;
...
SPPY::PyObject* Python_INS_Disassemble(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("s", INS_Disassemble(ins_object).c_str());
}
...
SPPY::PyObject* Python_INS_MemoryOperandCount(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_MemoryOperandCount(ins_object));
}

SPPY::PyObject* Python_INS_OperandIsAddressGenerator(SPPY::PyObject* self, SPPY::PyObject* args) {
    SPPY::PyObject* ins;
    SPPY::PyObject* n;
    Dyno::PyArg_ParseTuple(args, "k|O", &ins, &n);
    INS ins_object = *(INS*) ins;
    UINT32 n_object = (UINT32) Dyno::PyInt_AsLong(n);
...
SPPY::PyObject* Python_INS_MemoryOperandIsRead(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k|O", &ins, &memopidx);
    INS ins_object = *(INS*) ins;
    UINT32 memopidx_object = (UINT32) Dyno::PyInt_AsLong(memopidx);
...
SPPY::PyObject* Python_INS_SyscallStd(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_SyscallStd(ins_object));
}
...
SPPY::PyObject* Python_INS_Address(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_Address(ins_object));
}
...
SPPY::PyObject* Python_INS_Size(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_Size(ins_object));
}
...
SPPY::PyObject* Python_INS_DirectBranchOrCallTargetAddress(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_DirectBranchOrCallTargetAddress(ins_object));
}
...
SPPY::PyObject* Python_INS_NextAddress(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_NextAddress(ins_object));
}
...
SPPY::PyObject* Python_INS_EffectiveAddressWidth(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_EffectiveAddressWidth(ins_object));
}
...
SPPY::PyObject* Python_INS_MemoryDisplacement(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_MemoryDisplacement(ins_object));
}
...
SPPY::PyObject* Python_INS_MemoryScale(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_MemoryScale(ins_object));
}
...
SPPY::PyObject* Python_INS_OperandCount(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    Dyno::PyArg_ParseTuple(args, "k", &ins);
    INS ins_object = *(INS*) ins;
    return Dyno::Py_BuildValue("k", INS_OperandCount(ins_object));
}
...
SPPY::PyObject* Python_INS_OperandNameId(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS ins_object = *(INS*) ins;
    UINT32 n_object = (UINT32) Dyno::PyInt_AsLong(n);
    return Dyno::Py_BuildValue("k", INS_OperandNameId(ins_object, n_object));
}
...
SPPY::PyObject* Python_INS_OperandMemoryScale(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS ins_object = *(INS*) ins;
    UINT32 n_object = (UINT32) Dyno::PyInt_AsLong(n);
    return Dyno::Py_BuildValue("k", INS_OperandMemoryScale(ins_object, n_object));
}
...
SPPY::PyObject* Python_INS_OperandMemoryDisplacement(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS ins_object = *(INS*) ins;
    UINT32 n_object = (UINT32) Dyno::PyInt_AsLong(n);
    return Dyno::Py_BuildValue("k", INS_OperandMemoryDisplacement(ins_object, n_object));
}
...
SPPY::PyObject* Python_INS_OperandImmediate(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS ins_object = *(INS*) ins;
    UINT32 n_object = (UINT32) Dyno::PyInt_AsLong(n);
    return Dyno::Py_BuildValue("k", INS_OperandImmediate(ins_object, n_object));
}
...
SPPY::PyObject* Python_INS_OperandWidth(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS ins_object = *(INS*) ins;
    UINT32 n_object = (UINT32) Dyno::PyInt_AsLong(n);
    return Dyno::Py_BuildValue("k", INS_OperandWidth(ins_object, n_object));
}
...
SPPY::PyObject* Python_INS_MemoryOperandIndexToOperandIndex(SPPY::PyObject* self, SPPY::PyObject* args) {
    ...
    INS ins_object = *(INS*) ins;
    UINT32 memopidx_object = (UINT32) Dyno::PyInt_AsLong(memopidx);
    return Dyno::Py_BuildValue("k", INS_MemoryOperandIndexToOperandIndex(ins_object, memopidx_object));
}